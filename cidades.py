...
# Atalho para obter caminho de P1 para c2 usando strategy:
def search_path(P1,c2,strategy):
    my_prob = SearchProblem(cidades_portugal,P1,c2)
    my_tree = SearchTree(my_prob)
    my_tree.strategy = strategy
    return my_tree.search()

print(t.search(12), t.length, t.ramification, t.cost)
for no in t.most_cost_list:
    print(no.cost)